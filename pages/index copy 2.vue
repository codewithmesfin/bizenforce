...
<template>
  <div>
    <NuxtLayout />
    <PublicToolbarVue />
    <div class="flex ml-auto max-w-[94%] pt-16">
      <main class="
              mx-auto
              max-w-[100%]
             xs:w-[100%]
        ...
        <div class="sm:text-center lg:text-left">
          <h1 class="
                ...
                ">
            <span class="block xl:inline">Keep your project management </span>

            <span class="block text-blue-600 xl:inline"> simple and effective</span>
          </h1>
          <p class="
                  mt-3
            ...
            fugiat aliqua. <NuxtLink class="text-blue-600" to="/learn-more">Learn More ...</NuxtLink>
          </p>
          <div class="text-center lg:text-left py-5">
            <NuxtLink to="/get-started"
              class="block visible py-4 px-8 mb-4 text-xs md:text-xl font-semibold tracking-wide leading-none text-white bg-blue-600 rounded cursor-pointer sm:mr-3 sm:mb-0 sm:inline-block">
              Get
              Started</NuxtLink>

            <NuxtLink to="/how-to"
              class="block visible py-4 px-8 text-xs md:text-xl font-semibold leading-none bg-white rounded border border-solid cursor-pointer sm:inline-block border-slate-200 text-blue-600">
              How
              it works ?</NuxtLink>
          </div>
        </div>
      ...
      <div class="xs:w-[100%]
        ...
        <img class="h-56 md:w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full"
    ...
    <div class="bg-white py-12">
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="lg:text-center">
          <h2 class="text-lg font-semibold text-indigo-600">We are working hard to make things easier</h2>
          <p class="mt-2 text-3xl font-bold leading-8 tracking-tight text-gray-900 sm:text-4xl">
            A better way to manage your workflows <br /> and learn how to do them
          </p>
            ...
            <div v-for="feature in features" :key="feature.name" class="relative">
              <dt>
                <div class="absolute flex h-12 w-12 items-center justify-center rounded-md bg-indigo-500 text-white">
                  <!-- <component :vHtml="feature.icon" class="h-6 w-6" aria-hidden="true" /> -->
...
<script setup>
import PublicToolbarVue from "../components/PublicToolbar.vue";

const features = [
  {
    name: 'Tips on Project and Task Management',
    description:
  ...
  {
    name: 'Tips on Graduation Project',
    description:
      'Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores impedit perferendis suscipit eaque, iste dolor cupiditate blanditiis ratione.',
    icon: `<svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
